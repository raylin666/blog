...
<aside class="joe_aside">
    <section class="joe_aside__item author">
        <img width="100%" height="120" class="image lazyloaded" src="<?= _g('appearance-cbl'); ?>" alt="博主栏壁纸">
        <div class="user">
            <img width="75" height="75" class="avatar lazyloaded" src="<?php $user_cache = $CACHE->readCache('user');
            echo empty($user_cache[1]['avatar']) ? BLOG_URL . 'admin/views/images/avatar.jpg' : BLOG_URL . $user_cache[1]['avatar']; ?>" alt="博主头像">
            <a class="link" href="" target="_blank" rel="noopener noreferrer nofollow"><?php blog_author1(1); ?></a>
