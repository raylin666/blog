...
<script language="javascript">
    ...
    function createtime() {
        var grt = new Date('<?= _g('addition-date');?>');/*---这里是网站的启用时间--*/
...
<footer class="joe_footer" id="joe_footer">
    <div class="joe_container">
        <div class="item run"><span id="timeDate">载入天数...</span><span id="times">载入时分秒...</span></div>
        <div class="item"><?php doAction('index_footer'); ?><?= $footer_info; ?></div>
    </div>
</footer>
